...
#else
# define QUICKVEC_TEMPLATE template <typename TT_, typename AA_>
# define QUICKVEC          QuickVec<TT_,AA_>
# define QUICKVEC_TN       typename QuickVec<TT_,AA_>
...
#  if USE_UNIQUE_PTR == 0
    TT_ * data(){return data_;}
    TT_ const* data()const{return data_;}
#  else
    TT_ * data(){return data_.get();}
    TT_ const* data()const{return data_.get();}
#  endif
