...
class eventRecord {
 ...
 public:
  ...
  void insertSEB(crateHeader,ub_TPC_CrateData_v6); //in .cpp file
  void insertSEB(crateHeader,ub_PMT_CrateData_v6); //in .cpp file
  //void insertSEB_PMT(crateHeader,crateDataPMT); //in .cpp file
  //void insertSEB_TPC(crateHeader,crateData); //in .cpp file

  typedef std::map<crateHeader,ub_TPC_CrateData_v6,compareCrateHeader> sebMap_t;
  typedef std::map<crateHeader,ub_PMT_CrateData_v6,compareCrateHeader> sebMapPMT_t;
