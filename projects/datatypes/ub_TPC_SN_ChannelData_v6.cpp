...
namespace datatypes {
  ...
  void ub_TPC_SN_ChannelData_v6::dissectPackets()
  {
...
template void ub_TPC_SN_ChannelData_v6::decompress<uint16_t>(std::vector<uint16_t>&) const;
template void ub_TPC_SN_ChannelData_v6::decompress< int16_t>(std::vector< int16_t>&) const;
template void ub_TPC_SN_ChannelData_v6::decompress<uint32_t>(std::vector<uint32_t>&) const;
template void ub_TPC_SN_ChannelData_v6::decompress< int32_t>(std::vector< int32_t>&) const;
template void ub_TPC_SN_ChannelData_v6::decompress< float  >(std::vector< float  >&) const;
template void ub_TPC_SN_ChannelData_v6::decompress< double >(std::vector< double >&) const;
