...
template <>
bool  ub_MarkedRawCrateData<ub_TPC_CardData_v6>::isValid() noexcept
{
    return true;
}
...
ub_TPC_CrateData_v6::ub_TPC_CrateData_v6(ub_RawData const rawdata, bool createHeaderFromData):
