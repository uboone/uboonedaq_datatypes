...
void eventRecord::insertSEB(crateHeader cH,ub_TPC_CrateData_v6 cD){ 
  seb_map.emplace( cH,cD ); 
}

void eventRecord::insertSEB(crateHeader cH, ub_PMT_CrateData_v6 cD){ 
  seb_pmt_map.emplace( cH,cD );
}
