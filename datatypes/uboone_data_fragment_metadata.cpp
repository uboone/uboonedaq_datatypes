...
typedef  DissectorAdapter<ub_TPC_SN_CrateData_v6> ub_TPC_SN_CrateData_v6_dissector_t;
...
DissectorFactory::DissectorFactory()
{
  ...
  ub_TPC_SN_CardData_v6::neverDissectChannels();
  ...
  registerDissector("tpcsn",6,&ub_TPC_SN_CrateData_v6_dissector_t::buildCrateHeader);
}
